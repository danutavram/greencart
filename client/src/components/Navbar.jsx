  ...
  return (
    ...
    xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        border-gray-300 px-3 rounded-full">
        ...
        {!user ? (<button onClick={()=> setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary 
      ...
      >
        ...
        }} className="cursor-pointer px-6 py-2 mt-2 bg-primary hover:bg-indigo-primary transition text-white rounded-full text-sm">
          Login
        </button>) : (<button onClick={logout} className="cursor-pointer px-6 py-2 mt-2 bg-primary hover:bg-indigo-primary transition text-white rounded-full text-sm">
          Logout
        </button>)}
